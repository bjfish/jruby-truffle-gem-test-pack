...
Gem::Specification.new do |s|
  ...
  s.date = "2014-04-09"
  s.description = "Easy to use, feature complete Ruby client for RabbitMQ 2.0 and later versions.".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<amq-protocol>.freeze, [">= 1.9.2"])
    else
      s.add_dependency(%q<amq-protocol>.freeze, [">= 1.9.2"])
    end
  else
    s.add_dependency(%q<amq-protocol>.freeze, [">= 1.9.2"])
  end
